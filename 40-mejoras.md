> Documento histórico de la entrega anterior (V.02). La revisión vigente del circuito y sus pruebas se describe en `REVISION-SALAS.md`, `EXPERIENCIA.md` y `VALIDACION.md`.
