...
test('all SDF shapes and mapScene are byte-identical',()=>assert.equal(digest(source.slice(source.indexOf('vec3 qrot('),source.indexOf('vec3 normalAt('))),'985463a802ead20be7ba2bfeb71ce53dcee3a4ee1bf5236e2f273bef1262fbf0'));
