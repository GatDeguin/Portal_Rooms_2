...
def main():
    ...
    try:
      with sync_playwright() as p:
        ...
        page.locator('#pauseDialog [data-action=settings]').click();phase(page,'settings');page.locator('#sensitivity').evaluate("e=>{e.value='1.7';e.dispatchEvent(new Event('input',{bubbles:true}));}");page.locator('#invertX').check();page.locator('#quality').select_option('low')
